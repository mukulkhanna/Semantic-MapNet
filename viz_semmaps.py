...
DIR = 'data/vince_best_outputs_check/semmap'
# DIR = 'data/my_gt_outputs/semmap'
...
for _file in FILES:
    ...
    cv2.imwrite(f'obs_map_vince_best_check_{_file[0:4]}.png', obs_map* 255)
    ...
    cv2.imwrite(f'semmap_vince_best_check_{_file[0:4]}.png', semmap_color)
