...
# pred_dir = 'data/noisy_1.0_outputs/'
# pred_dir = 'data/noisy_0.5_outputs/'
# pred_dir = 'data/vince_best_outputs_check/'
pred_dir = 'data/vince_best_outputs/'
# pred_dir = 'data/my_gt_outputs_x/'
#########################################################################
print(pred_dir)
if dataset == 'mp3d':
    paths = json.load(open('data/paths.json', 'r'))
    envs_splits = json.load(open('data/envs_splits copy.json', 'r'))
...
with h5py.File(filename, 'w') as f:
    for env in tqdm(envs):
        ...
        observed_map = np.array(gt_h5_file['mask'])
        ...
        # obj_gt = gt_semmap.flatten()
        # obj_pred = pred_semmap.flatten()
