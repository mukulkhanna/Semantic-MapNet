...
class HabitatUtils:
    ...
    def set_agent_state(self):
        self.sim.set_agent_state(self._position, self._rotation)
    ...
    def render_semantic_mpcat40(self):
        ...
        for oid in object_ids:
            ...
            if mpcat40_index <= 0 or mpcat40_index > 40:
                mpcat40_index = 40  # remap -1 to misc
    ...
    def get_objects_in_house(self):
        objects = {
            ...
            for o in self.semantic_annotations.objects
            if o is not None
        }
        return objects

    def get_topdown_map(
        self, map_resolution=(1250, 1250), num_samples=20000, draw_border=True
    ):
    ...
    def draw_agent(self, map, agent_center_coord, agent_rotation, agent_radius_px=5):
        maps.draw_agent(
            map, agent_center_coord, agent_rotation, agent_radius_px=agent_radius_px
        )
        return map
